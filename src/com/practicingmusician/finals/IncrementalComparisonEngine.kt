    ...
    for (index in 0 until ideal.count()) {
      ...
      if (comparisonFlags.testDuration) {
        ...
        if (durationDifferenceRatio < listenerApp.parameters.allowableDurationRatio) {
          ...
          feedbackItemTypes.add(FeedbackMetric("duration", "SHORT", durationDifferenceRatioRounded))
          ...
          feedbackItemTypes.add(FeedbackMetric("duration", "LONG", durationDifferenceRatioRounded))
      ...
      if (comparisonFlags.testRhythm) {
        ...
        if (distanceAway > listenerApp.parameters.allowableRhythmMargin) {
          ...
          feedbackItemTypes.add(FeedbackMetric("speed", "EARLY", distanceAwayRounded))
          ...
          feedbackItemTypes.add(FeedbackMetric("speed", "LATE", distanceAwayRounded))
          //feedbackItemTypes.add(FeedbackMetric("speed", "" + distanceAwayRounded))
