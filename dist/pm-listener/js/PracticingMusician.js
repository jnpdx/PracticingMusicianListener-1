(function (_, Kotlin) {
  ...
  ListenerApp.prototype.toggleState = function () {
    ...
    this.parameters.tolerances.allowableCentsMargin = toDouble((Kotlin.isType(tmp$ = document.getElementById('allowableCentsMargin'), HTMLInputElement) ? tmp$ : Kotlin.throwCCE()).value);
    this.parameters.tolerances.allowableRhythmMargin = toDouble((Kotlin.isType(tmp$_0 = document.getElementById('allowableRhythmMargin'), HTMLInputElement) ? tmp$_0 : Kotlin.throwCCE()).value);
    this.parameters.tolerances.allowableDurationRatio = toDouble((Kotlin.isType(tmp$_1 = document.getElementById('allowableDurationRatio'), HTMLInputElement) ? tmp$_1 : Kotlin.throwCCE()).value);
    this.parameters.minimumSizes.minDurationInBeats = toDouble((Kotlin.isType(tmp$_2 = document.getElementById('minDurationInBeats'), HTMLInputElement) ? tmp$_2 : Kotlin.throwCCE()).value);
    tmp$_3 = this.exerciseManager.timeKeeper.state;
    if (Kotlin.equals(tmp$_3, TimeKeeper$TimeKeeperState$Stopped_getInstance())) {
     ...
     else if (Kotlin.equals(tmp$_3, TimeKeeper$TimeKeeperState$Running_getInstance()))
      this.exerciseManager.stop();
    else
      Kotlin.equals(tmp$_3, TimeKeeper$TimeKeeperState$Completed_getInstance());
  };
  ...
  function ExerciseManager$setup$lambda(this$ExerciseManager) {
    return function (it) {
      ...
      if (this$ExerciseManager.currentExercise != null) {
        ...
        var tmp$ = listenerApp.exercise.notes;
        var $receiver = this$ExerciseManager_0.pitchTracker.samples;
        var results = runComparison(false, tmp$, Kotlin.kotlin.collections.copyToArray($receiver), listenerApp.getTempo() | 0, listenerApp.parameters.minimumSizes, listenerApp.parameters.factorWeights, listenerApp.parameters.correctLevels, listenerApp.parameters.tolerances, combinedComparisonFlags);
        listenerApp.clearFeedbackItems();
        var $receiver_0 = results.feedbackItems;
        var tmp$_0;
  ...
  ExerciseManager.prototype.analyze_14dthe$ = function (timestamp) {
    ...
    if (this.currentExercise != null) {
      ...
      var tmp$ = listenerApp.exercise.notes;
      var $receiver = this.pitchTracker.samples;
      var results = runComparison(true, tmp$, Kotlin.kotlin.collections.copyToArray($receiver), listenerApp.getTempo() | 0, listenerApp.parameters.minimumSizes, listenerApp.parameters.factorWeights, listenerApp.parameters.correctLevels, listenerApp.parameters.tolerances, combinedComparisonFlags);
      listenerApp.clearFeedbackItems();
      var $receiver_0 = results.feedbackItems;
      var tmp$_0;
      for (tmp$_0 = 0; tmp$_0 !== $receiver_0.length; ++tmp$_0) {
  ...
  function generateResultForDatabase($receiver) {
    ...
    var destination_0 = Kotlin.kotlin.collections.ArrayList_init_ww73n8$($receiver_1.length);
    var tmp$_0;
    ...
    var destination_1 = Kotlin.kotlin.collections.ArrayList_init_ww73n8$($receiver_2.length);
    var tmp$_1;
  ...
  ListenerNetworkManager.prototype.buildAndSendRequest_fhpv3e$ = function (results) {
    ...
    tmp$ = listenerApp.parameters.tolerances.allowableCentsMargin | 0;
